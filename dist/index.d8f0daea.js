...
const renderSpinner = function(parentEl) {
    ...
    parentEl.injectHtml = '';
    parentEl.insertAdjacentHTML('afterbegin', injectHtml);
};
const showRecipe = async function() {
    try {
        ...
        recipeContainer.insertAdjacentHTML('afterbegin', injectHtml);
    } catch (err) {
        alert(err);
    }
};
...
},{"url:../img/icons.svg":"2Mh0L","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"2Mh0L":[function(require,module,exports) {
